...
import Labels from './Labels'
    ...
    const Message = ({ id, subject, read, starred, labels, selected, starMessage, selectMessage, messageBody, toggleBody}) => {
    ...
    return(
                <div className={`row message ${isRead} ${isSelected} onClick={${() => toggleBody(id)}`}>
